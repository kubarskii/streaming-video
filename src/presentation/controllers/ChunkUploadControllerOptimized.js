// @ts-check
// Presentation: Optimized ChunkUploadController
// Removes disk writes - streams directly to B2
    ...
    async uploadChunk(req, res) {
        ...
        try {
            ...
            if (!chunkFile || !chunkFile.buffer) {
                return this.sendJson(res, 400, { error: 'Missing chunk data' });
            }
...
module.exports = ChunkUploadControllerOptimized;
